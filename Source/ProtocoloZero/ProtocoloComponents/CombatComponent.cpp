...
void UCombatComponent::BeginPlay()
{
	...
	if (Personagem)
	{
		Personagem->GetCharacterMovement()->MaxWalkSpeed = BaseWalkSpeed;
	}
}
...
void UCombatComponent::SetAiming(bool bIsAiming)
{
	...
	if (Personagem)
	{
		Personagem->GetCharacterMovement()->MaxWalkSpeed = bIsAiming ? AimWalkSpeed : BaseWalkSpeed;
	}
}
...
{
	if (EquippedWeapon && Personagem)
	{
		Personagem->GetCharacterMovement()->bOrientRotationToMovement = false;
		Personagem->bUseControllerRotationYaw = true;
	}
}
